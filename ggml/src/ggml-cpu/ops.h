...
void ggml_compute_forward_escha_moe(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_escha_linear(const struct ggml_compute_params * params, struct ggml_tensor * dst);
